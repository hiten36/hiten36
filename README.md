...
## Languages and Tools:
[![My Skills](https://skillicons.dev/icons?i=html,css,js,react,next,nodejs,express,mongodb,graphql,bootstrap,tailwind,materialui,aws,c,cpp,java,androidstudio,py,php,mysql,postgres,pug,jquery,github,django,ai,heroku,vscode&theme=dark)](https://skillicons.dev)
